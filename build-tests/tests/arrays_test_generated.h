...
bool operator!=(const ArrayStruct &lhs, const ArrayStruct &rhs);
bool operator==(const LargeArrayStruct &lhs, const LargeArrayStruct &rhs);
bool operator!=(const LargeArrayStruct &lhs, const LargeArrayStruct &rhs);
...
inline const ::flatbuffers::TypeTable *LargeArrayStructTypeTable();
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) LargeArrayStruct FLATBUFFERS_FINAL_CLASS {
 private:
  uint8_t d_[64];
  float e_[64];
  uint8_t f_[64];
  MyGame::Example::NestedStruct g_[64];
  int8_t h_[64];

 public:
  static const ::flatbuffers::TypeTable *MiniReflectTypeTable() {
    return LargeArrayStructTypeTable();
  }
  LargeArrayStruct()
      : d_(),
        e_(),
  ...
  LargeArrayStruct(::flatbuffers::span<const uint8_t, 64> _d, ::flatbuffers::span<const float, 64> _e, ::flatbuffers::span<const uint8_t, 64> _f, ::flatbuffers::span<const MyGame::Example::NestedStruct, 64> _g, ::flatbuffers::span<const MyGame::Example::TestEnum, 64> _h) {
    ::flatbuffers::CastToArray(d_).CopyFromSpan(_d);
    ::flatbuffers::CastToArray(e_).CopyFromSpan(_e);
    ::flatbuffers::CastToArray(f_).CopyFromSpan(_f);
    ::flatbuffers::CastToArray(g_).CopyFromSpan(_g);
    ::flatbuffers::CastToArrayOfEnum<MyGame::Example::TestEnum>(h_).CopyFromSpan(_h);
  }
  const ::flatbuffers::Array<uint8_t, 64> *d() const {
    return &::flatbuffers::CastToArray(d_);
  }
  ::flatbuffers::Array<uint8_t, 64> *mutable_d() {
    return &::flatbuffers::CastToArray(d_);
  }
  const ::flatbuffers::Array<float, 64> *e() const {
    return &::flatbuffers::CastToArray(e_);
  }
  ::flatbuffers::Array<float, 64> *mutable_e() {
    return &::flatbuffers::CastToArray(e_);
  }
  const ::flatbuffers::Array<uint8_t, 64> *f() const {
    return &::flatbuffers::CastToArray(f_);
  }
  ::flatbuffers::Array<uint8_t, 64> *mutable_f() {
    return &::flatbuffers::CastToArray(f_);
  }
  const ::flatbuffers::Array<MyGame::Example::NestedStruct, 64> *g() const {
    return &::flatbuffers::CastToArray(g_);
  }
  ::flatbuffers::Array<MyGame::Example::NestedStruct, 64> *mutable_g() {
    return &::flatbuffers::CastToArray(g_);
  }
  const ::flatbuffers::Array<MyGame::Example::TestEnum, 64> *h() const {
    return &::flatbuffers::CastToArrayOfEnum<MyGame::Example::TestEnum>(h_);
  }
  ::flatbuffers::Array<MyGame::Example::TestEnum, 64> *mutable_h() {
    return &::flatbuffers::CastToArrayOfEnum<MyGame::Example::TestEnum>(h_);
  }
};
FLATBUFFERS_STRUCT_END(LargeArrayStruct, 2496);

inline bool operator==(const LargeArrayStruct &lhs, const LargeArrayStruct &rhs) {
  return
      (*lhs.d() == *rhs.d()) &&
      (*lhs.e() == *rhs.e()) &&
      (*lhs.f() == *rhs.f()) &&
...
inline const ::flatbuffers::TypeTable *LargeArrayStructTypeTable() {
  ...
  static const int16_t array_sizes[] = { 64, 64, 64, 64, 64,  };
  static const int64_t values[] = { 0, 64, 320, 384, 2432, 2496 };
  static const char * const names[] = {
    "d",
    "e",
    "f",
  ...
  static const ::flatbuffers::TypeTable tt = {
    ::flatbuffers::ST_STRUCT, 5, type_codes, type_refs, array_sizes, values, names
  };
  return &tt;
}
